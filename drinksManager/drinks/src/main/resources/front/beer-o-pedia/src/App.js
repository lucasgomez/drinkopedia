			...
			<Tab eventKey="1" title={ 'Les cartes de Bière' }>
				...
				<ButtonGroup vertical>
					...
					<DropdownButton title="Par couleur" id="bg-vertical-dropdown-1">
						<ListButton listName="colors"/>
					</DropdownButton>
					<DropdownButton title="Par style" id="bg-vertical-dropdown-1">
						<ListButton listName="styles"/>
					</DropdownButton>
					<DropdownButton title="Par producteur" id="bg-vertical-dropdown-1">
						<ListButton listName="producers"/>
					</DropdownButton>
					<DropdownButton title="Par origine" id="bg-vertical-dropdown-1">
						<ListButton listName="places"/>
					</DropdownButton>
				</ButtonGroup>
			</Tab>
